...
$(document).ready(function () {
    if (
        ...
        $(".accordeon .accordeon-block")
            ...
            .prev()
            .click(function () {
                $(this).parents(".accordeon").hasClass("accordeon-active") ? $(".accordeon").removeClass("accordeon-active") : ($(".accordeon").removeClass("accordeon-active"), $(this).parents(".accordeon").addClass("accordeon-active")),
        ...
        $(".private-btn").on("click", function (t) {
            t.preventDefault(), $(".private").toggleClass("active");
        }),
        $("#statistics1").length)
    ) {
        ...
        (t.text.style.fontFamily = '"Montserrat", Helvetica, sans-serif'), (t.text.style.fontSize = "34px"), t.animate($("#procent-1").text(), { duration: 1500 });
    }
    if ($("#statistics2").length) {
        ...
        (e.text.style.fontFamily = '"Montserrat", Helvetica, sans-serif'), (e.text.style.fontSize = "34px"), e.animate($("#procent-2").text(), { duration: 1500 });
    }
    if ($("#statistics3").length) {
        ...
        (a.text.style.fontFamily = '"Montserrat", Helvetica, sans-serif'), (a.text.style.fontSize = "28px"), a.animate($("#procent-3").text(), { duration: 1500 });
    }
    if ($("#statistics4").length) {
        ...
        (o.text.style.fontFamily = '"Montserrat", Helvetica, sans-serif'), (o.text.style.fontSize = "34px"), o.animate($("#procent-4").text(), { duration: 1500 });
    }
    if ($("#statistics5").length) {
        var s = new ProgressBar.Circle(statistics5, {
            color: "#fff",
            strokeWidth: 4,
            trailWidth: 4,
            easing: "easeInOut",
        ...
        (s.text.style.fontFamily = '"Montserrat", Helvetica, sans-serif'), (s.text.style.fontSize = "34px"), s.animate($("#procent-5").text(), { duration: 1500 });
    }
});
