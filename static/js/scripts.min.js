...
$(function () {
    ...
    $(document).ready(function () {
        if (
            ...
            $(".modal-btn").on("click", function (t) {
                t.preventDefault(), $(".forms,.forms-bg,.forms-tab").removeClass("open");
                var e = $(this).attr("href");
                $(e).addClass("open"), $(".forms,.forms-bg").addClass("open");
            }),
            $(".forms-bg,.forms-back").on("click", function () {
                $(".forms,.forms-bg,.forms-tab").removeClass("open");
            }),
            $(".testimonials-slider").on("init reInit", function (t, e) {
                var a = e.slideCount;
                $("#range").attr("max", a);
            }),
            $(".testimonials-slider").on("afterChange", function (t, e, a) {
                $("#range").val(a + 1);
            }),
            $("#range").on("input change", function () {
                $(".testimonials-slider").slick("slickGoTo", this.value - 1);
            }),
            $(".testimonials-slider").slick({
                ...
                speed: 500,
                variableWidth: !0,
                responsive: [{ breakpoint: 800, settings: { centerMode: !0 } }],
            }),
            $(".header-bar").on("click", function () {
                $(".header").toggleClass("header-active"), $(".forms,.forms-bg,.forms-tab").removeClass("open");
            }),
            $(".tab-list li a").on("click", function (t) {
                t.preventDefault(), $(".tab-list li a").removeClass("active"), $(".tab").removeClass("tab-active");
                var e = $(t.target).attr("href");
                $(e).addClass("tab-active"), $(this).addClass("active");
            }),
            $(".profile-accordeon__subtitle").on("click", function (t) {
            ...
            $(".form-btn").on("click", function (t) {
                t.preventDefault(), $(".main-form").toggleClass("active");
            }),
            $(document).on("click", function (t) {
                var e = $(".main-form");
                e.is(t.target) || 0 !== e.has(t.target).length || $(".form-btn").is(t.target) || $(".main-form").removeClass("active");
            }),
            $(".header-bell__top").on("click", function () {
            $(".header-bell__drop").toggleClass("active"),
                $(".header-drop").removeClass("active");
            fetch("/user/view_notify/", {
                    method: 'post',
            ...
            $(document).on("click", function (t) {
                var e = $(".header-user");
                e.is(t.target) || 0 !== e.has(t.target).length || $(".header-drop").removeClass("active");
            }),
            $(document).on("click", function (t) {
                var e = $(".header-bell");
                e.is(t.target) || 0 !== e.has(t.target).length || $(".header-bell__drop").removeClass("active");
            }),
            $(".header-user__top").on("click", function () {
                if (window.location.href.split('/').includes('user')){
                     $(".header-bell__drop").removeClass("active"), $(window).width() >= 1e3 ? $(".header-drop").toggleClass("active") : $(".personalArea-sidebar").toggleClass("active");
                }else{
                    $(".header-bell__drop").removeClass("active"), $(window).width() >= 320 ? $(".header-drop").toggleClass("active") : $(".personalArea-sidebar").toggleClass("active");
                }
                ...
                $(".datepicker").datepicker(
                    {
                        ...
                        onClose: function (t, e) {
                            var a = $("#ui-datepicker-div .ui-datepicker-month :selected").val(),
                                i = $("#ui-datepicker-div .ui-datepicker-year :selected").val();
                            $(this).val($.datepicker.formatDate("dd/mm/yy", new Date(i, a, e.selectedDay)));
                        },
                    },
            ...
            $(".private-btn").on("click", function (t) {
                t.preventDefault(), $(".lkCard").slideUp(0), $(".score .private").slideToggle(200);
            }),
            $(".card-btn").on("click", function (t) {
                t.preventDefault(), $(".score .private").slideUp(0), $(".lkCard").slideToggle(200);
            }),
            $(".bid-btn").on("click", function (t) {
                t.preventDefault(), $(".register-bid").slideToggle(200);
            }),
            $("#statistics1").length)
        ) {
            var t = new ProgressBar.Circle(statistics1, {
                color: "#fff",
                strokeWidth: 4,
                trailWidth: 4,
                easing: "easeInOut",
                ...
                step: function (t, e) {
                    ...
                    0 === a ? e.setText("") : e.setText(a + "<span>Год</span>");
                },
            });
            (t.text.style.fontFamily = '"Montserrat", Helvetica, sans-serif'), (t.text.style.fontSize = "34px"), t.animate($("#procent-1").text(), { duration: 2200 });
        }
        if ($("#statistics2").length) {
            var e = new ProgressBar.Circle(statistics2, {
                color: "#fff",
                strokeWidth: 4,
                trailWidth: 4,
                easing: "easeInOut",
            ...
            (e.text.style.fontFamily = '"Montserrat", Helvetica, sans-serif'), (e.text.style.fontSize = "34px"), e.animate($("#procent-2").text(), { duration: 2200 });
        }
        if ($("#statistics3").length) {
            var a = new ProgressBar.Circle(statistics3, {
                ...
                step: function (t, e) {
                    ...
                    0 === a ? e.setText("") : e.setText(a + "<span>Рублей</span>");
                },
            });
        ...
        if ($("#statistics4").length) {
            var i = new ProgressBar.Circle(statistics4, {
                color: "#fff",
                strokeWidth: 4,
                trailWidth: 4,
                easing: "easeInOut",
                ...
                step: function (t, e) {
                    ...
                    0 === a ? e.setText("") : e.setText(a + "<b>%</b>");
                },
            });
            (i.text.style.fontFamily = '"Montserrat", Helvetica, sans-serif'), (i.text.style.fontSize = "34px"), i.animate($("#procent-4").text(), { duration: 2200 });
        }
        if ($("#statistics5").length) {
            var o = new ProgressBar.Circle(statistics5, {
                color: "#fff",
                strokeWidth: 4,
                trailWidth: 4,
                easing: "easeInOut",
                ...
                step: function (t, e) {
                    e.path.setAttribute("stroke", t.color), e.path.setAttribute("stroke-width", t.width);
                    var a = Math.round(e.value() * $("#statistics5-5").text());
                    0 === a ? e.setText("") : e.setText(a + "<b>Рублей</b>");
                },
            });
            (o.text.style.fontFamily = '"Montserrat", Helvetica, sans-serif'), (o.text.style.fontSize = "34px"), o.animate($("#procent-5").text(), { duration: 2200 });
        }
        var r = $(".modal");
        $(".button-modal").on("click", function (t) {
            t.preventDefault();
            var e = $(this).attr("href");
            $(e).addClass("open"), $(".modal-overlay").addClass("open-overlay"), $("html,body").addClass("scroll-hidden");
        }),
            $(".modal-close, .modal-overlay").on("click", function () {
                $(r).removeClass("open"), $(".modal-overlay").removeClass("open-overlay"), $("html,body").removeClass("scroll-hidden");
            }),
            $(".drop-buttons").on("click", function (t) {
                t.preventDefault(), $(this).hasClass("main-btn") ? ($(".modal-col__drop-1").slideToggle(200), $(".modal-col__drop-2").slideUp(200)) : ($(".modal-col__drop-1").slideUp(200), $(".modal-col__drop-2").slideToggle(200));
            }),
            $("#slider1").length &&
                (noUiSlider.create(slider1, { start: 500, step: 100, animate: !1, connect: "lower", range: { min: 500, max: 5e5 }, decimals: 0 }),
                slider1.noUiSlider.on("update", function (t, e) {
                    (slider1Value.innerHTML = ((t[e] / 100) * 100)
                        .toFixed(0)
                        .toString()
                        .replace(/\B(?=(\d{3})+(?!\d))/g, ",")),
                        t[e] < 1e4
                            ? ((cashback.innerHTML = ((t[e] / 100) * 10)
                                  .toFixed(0)
                                  .toString()
                                  .replace(/\B(?=(\d{3})+(?!\d))/g, ",")),
                              (percent.innerHTML = 10))
                            : t[e] >= 1e4 && t[e] < 5e4
                            ? ((cashback.innerHTML = ((t[e] / 100) * 20)
                                  .toFixed(0)
                                  .toString()
                                  .replace(/\B(?=(\d{3})+(?!\d))/g, ",")),
                              (percent.innerHTML = 20))
                            : t[e] >= 5e4 && t[e] < 1e5
                            ? ((cashback.innerHTML = ((t[e] / 100) * 30)
                                  .toFixed(0)
                                  .toString()
                                  .replace(/\B(?=(\d{3})+(?!\d))/g, ",")),
                              (percent.innerHTML = 30))
                            : t[e] >= 1e5 &&
                              ((cashback.innerHTML = ((t[e] / 100) * 40)
                                  .toFixed(0)
                                  .toString()
                                  .replace(/\B(?=(\d{3})+(?!\d))/g, ",")),
