...
$(document).ready(function(){if(AOS.init({startEvent:"load"}),$(window).on("scroll",function(){$(this).scrollTop()>0?$(".header").addClass("header-fixed"):$(".header").removeClass("header-fixed")}),$(".modal-btn").on("click",function(t){t.preventDefault(),$(".forms,.forms-bg,.forms-tab").removeClass("open");var e=$(this).attr("href");$(e).addClass("open"),$(".forms,.forms-bg").addClass("open")}),$(".forms-bg,.forms-back").on("click",function(){$(".forms,.forms-bg,.forms-tab").removeClass("open")}),$(".testimonials-slider").on("init reInit",function(t,e){var a=e.slideCount;$("#range").attr("max",a)}),$(".testimonials-slider").on("afterChange",function(t,e,a){$("#range").val(a+1)}),$("#range").on("input change",function(){$(".testimonials-slider").slick("slickGoTo",this.value-1)}),$(".testimonials-slider").slick({infinite:!0,arrows:!0,dots:!1,nextArrow:'<button class="slick-arrow slick-next"></button>',prevArrow:'<button class="slick-arrow slick-prev"></button>',slidesToShow:4,swipeToSlide:!0,autoplay:!1,speed:300,variableWidth:!0,responsive:[{breakpoint:800,settings:{centerMode:!0}}]}),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active"),$(".forms,.forms-bg,.forms-tab").removeClass("open")}),$(".tab-list li a").on("click",function(t){t.preventDefault(),$(".tab-list li a").removeClass("active"),$(".tab").removeClass("tab-active");var e=$(t.target).attr("href");$(e).addClass("tab-active"),$(this).addClass("active")}),$(".profile-accordeon__subtitle").on("click",function(t){$(this).parents(".profile-accordeon").hasClass("active")?$(".profile-accordeon").removeClass("active").find(".profile-tab").slideUp():($(".profile-accordeon").removeClass("active").find(".profile-tab").slideUp(),$(this).parents(".profile-accordeon").addClass("active").find(".profile-tab").slideDown())}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$(".form-btn").on("click",function(t){t.preventDefault(),$(".main-form").toggleClass("active")}),$(document).on("click",function(t){var e=$(".main-form");e.is(t.target)||0!==e.has(t.target).length||$(".form-btn").is(t.target)||$(".main-form").removeClass("active")}),$(".header-bell__top").on("click",function(){$(".header-bell__drop").toggleClass("active"),$(".header-drop").removeClass("active")}),$(document).on("click",function(t){var e=$(".header-user");e.is(t.target)||0!==e.has(t.target).length||$(".header-drop").removeClass("active")}),$(document).on("click",function(t){var e=$(".header-bell");e.is(t.target)||0!==e.has(t.target).length||$(".header-bell__drop").removeClass("active")}),$(".header-user__top").on("click",function(){$(".header-bell__drop").removeClass("active"),$(window).width()>=1e3?$(".header-drop").toggleClass("active"):$(".personalArea-sidebar").toggleClass("active")}),0==!$(".datepicker").length&&$(".datepicker").datepicker(),$(window).resize(function(){0==!$(".datepicker").length&&$(".datepicker").datepicker("hide")}),$(".private-btn").on("click",function(t){t.preventDefault(),$(".private").toggleClass("active")}),$("#statistics1").length){var t=new ProgressBar.Circle(statistics1,{color:"#fff",strokeWidth:4,trailWidth:4,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#fff",width:4},to:{color:"#F99422",width:4},step:function(t,e){e.path.setAttribute("stroke",t.color),e.path.setAttribute("stroke-width",t.width);var a=Math.round(e.value()*$("#statistics1-1").text());0===a?e.setText(""):e.setText(a+"<span>Год</span>")}});t.text.style.fontFamily='"Montserrat", Helvetica, sans-serif',t.text.style.fontSize="34px",t.animate($("#procent-1").text(),{duration:1500})}if($("#statistics2").length){var e=new ProgressBar.Circle(statistics2,{color:"#fff",strokeWidth:4,trailWidth:4,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#fff",width:4},to:{color:"#F99422",width:4},step:function(t,e){e.path.setAttribute("stroke",t.color),e.path.setAttribute("stroke-width",t.width);var a=Math.round(e.value()*$("#statistics2-2").text());0===a?e.setText(""):e.setText(a)}});e.text.style.fontFamily='"Montserrat", Helvetica, sans-serif',e.text.style.fontSize="34px",e.animate($("#procent-2").text(),{duration:1500})}if($("#statistics3").length){var a=new ProgressBar.Circle(statistics3,{color:"#fff",strokeWidth:4,trailWidth:4,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#fff",width:4},to:{color:"#F99422",width:4},step:function(t,e){e.path.setAttribute("stroke",t.color),e.path.setAttribute("stroke-width",t.width);var a=Math.round(e.value()*$("#statistics3-3").text());0===a?e.setText(""):e.setText(a+"<span>Рублей</span>")}});a.text.style.fontFamily='"Montserrat", Helvetica, sans-serif',a.text.style.fontSize="28px",a.animate($("#procent-3").text(),{duration:1500})}if($("#statistics4").length){var o=new ProgressBar.Circle(statistics4,{color:"#fff",strokeWidth:4,trailWidth:4,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#fff",width:4},to:{color:"#F99422",width:4},step:function(t,e){e.path.setAttribute("stroke",t.color),e.path.setAttribute("stroke-width",t.width);var a=Math.round(e.value()*$("#statistics4-4").text());0===a?e.setText(""):e.setText(a+"<b>%</b>")}});o.text.style.fontFamily='"Montserrat", Helvetica, sans-serif',o.text.style.fontSize="34px",o.animate($("#procent-4").text(),{duration:1500})}if($("#statistics5").length){var s=new ProgressBar.Circle(statistics5,{color:"#fff",strokeWidth:4,trailWidth:4,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#fff",width:4},to:{color:"#F99422",width:4},step:function(t,e){e.path.setAttribute("stroke",t.color),e.path.setAttribute("stroke-width",t.width);var a=Math.round(e.value()*$("#statistics5-5").text());0===a?e.setText(""):e.setText(a+"<b>Рублей</b>")}});s.text.style.fontFamily='"Montserrat", Helvetica, sans-serif',s.text.style.fontSize="34px",s.animate($("#procent-5").text(),{duration:1500})}});